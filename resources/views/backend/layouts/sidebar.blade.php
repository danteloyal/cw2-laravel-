        ...
        <li class="nav-item nav-profile">
            <div class="nav-link">
                <div class="profile-image">
                    <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" alt="image" />
                </div>
            ...
            <div class="collapse" id="page-layouts">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item d-none d-lg-block"> <a class="nav-link"
                            href="{{ route('students.create') }}">Add
                            Students</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('students.index') }}">View Students</a>
                    </li>
                </ul>
            </div>
        </li>
       ...
       <li class="nav-item d-none d-lg-block">
            ...
            <div class="collapse" id="sidebar-layouts">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('teachers.index') }}">View Teacher</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('subjects.index') }}">View Subjects</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="{{ route('levels.create') }}">Add Levels</a>
                    </li>
